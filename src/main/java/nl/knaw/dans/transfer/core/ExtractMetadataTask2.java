...
@Slf4j
public class ExtractMetadataTask2 extends SourceDirItemProcessor implements Runnable {
    ...
    public ExtractMetadataTask2(Path srcDir, String ocflStorageRoot, Path outboxProcessed, Path outboxFailed, Path outboxRejected,
        ...
        super(srcDir, "DVE", new DveFileFilter().toPredicate(), CreationTimeComparator.getInstance(), fileService);
